...
public class CopyOfReportDialog extends Dialog {
	...
	private Text text_2;
	private Text text_3;
	private CopyOfReportDialogModelProvider modelProvider;
	 ...
	 * @param style
	 */
	public CopyOfReportDialog(Shell parent) {
		super(parent);
		setText("Search Customers");
		modelProvider = new CopyOfReportDialogModelProvider();
	}
