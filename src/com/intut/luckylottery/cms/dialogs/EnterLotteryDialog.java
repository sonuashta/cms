...
//		fd_grpPersonalDetails.right = new FormAttachment(100, -10);
...
//		fd_lblZip_1.top = new FormAttachment(cityText, 6);
//		fd_lblZip_1.left = new FormAttachment(lblName, 0, SWT.LEFT);
...
//		fd_zipText.top = new FormAttachment(lblZip_1, 6);
//		fd_zipText.left = new FormAttachment(lblName, 0, SWT.LEFT);
//		zipText.setLayoutData(fd_zipText);
//
//		Label lblNewLabel_1 = new Label(grpPersonalDetails, SWT.NONE);
//		FormData fd_lblNewLabel_1 = new FormData();
//		fd_lblNewLabel_1.top = new FormAttachment(lblZip, 0, SWT.TOP);
//		fd_lblNewLabel_1.left = new FormAttachment(lblMobile, 0, SWT.LEFT);
//		lblNewLabel_1.setLayoutData(fd_lblNewLabel_1);
//		lblNewLabel_1.setText("Email");
//
//		emailText = new Text(grpPersonalDetails, SWT.BORDER);
//		FormData fd_emailText = new FormData();
//		fd_emailText.top = new FormAttachment(cityText, 0, SWT.TOP);
//		fd_emailText.left = new FormAttachment(lblMobile, 0, SWT.LEFT);
...
//		fd_grpCode.right = new FormAttachment(100, -242);
//
//		Label lblNewLabel = new Label(grpPersonalDetails, SWT.NONE);
//		FormData fd_lblNewLabel = new FormData();
//		fd_lblNewLabel.top = new FormAttachment(lblZip_1, 0, SWT.TOP);
//		fd_lblNewLabel.left = new FormAttachment(lblMobile, 0, SWT.LEFT);
...
//		fd_mobile1Text.top = new FormAttachment(zipText, 0, SWT.TOP);
//		fd_mobile1Text.left = new FormAttachment(lblMobile, 0, SWT.LEFT);
...
//			@Override
//			public void widgetSelected(SelectionEvent e) {
//				modelProvider.setVerifyButtonEnabled(true);
...
//		fd_grpPersonalDetails.bottom = new FormAttachment(grpLotteryType, -6);
//		grpLotteryType.setText("Lottery type");
//		grpLotteryType.setLayout(new FormLayout());
//		FormData fd_grpLotteryType = new FormData();
//		fd_grpLotteryType.left = new FormAttachment(0, 381);
//		fd_grpLotteryType.right = new FormAttachment(100, -10);
//		fd_grpLotteryType.top = new FormAttachment(0, 251);
//
...
//					modelProvider.addCodesFromCSV(file);
...
//		fd_grpCode.bottom = new FormAttachment(label, -6);
//		fd_grpLotteryType.bottom = new FormAttachment(label, -32);
...
//		btnVerified.addSelectionListener(new SelectionAdapter() {
//			@Override
//			public void widgetSelected(SelectionEvent e) {
//				if(!modelProvider.verifyEntry())
//					MessageDialog.openError(shell, "Error", "Please add the required fields");
//				else{
...
//		//
//		IObservableValue bumperComboObserveTextObserveWidget = SWTObservables.observeText(bumperCombo);
//		IObservableValue modelProviderSelectedBumperObserveValue = BeansObservables.observeValue(modelProvider, "selectedBumper");
//		bindingContext.bindValue(bumperComboObserveTextObserveWidget, modelProviderSelectedBumperObserveValue, null, null);
//		//
