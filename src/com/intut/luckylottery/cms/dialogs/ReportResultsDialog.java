...
public class ReportResultsDialog extends Dialog {
	private DataBindingContext m_bindingContext;

	protected Object result;
	protected Shell shlResults;
	private Table table;
	private ReportResultModelProvider modelProvider;
	 ...
	 * @param style
	 */
	public ReportResultsDialog(Shell parent, SearchResult searchResult) {
		super(parent);
		setText("SWT Dialog");
		modelProvider = new ReportResultModelProvider(searchResult);
	}
