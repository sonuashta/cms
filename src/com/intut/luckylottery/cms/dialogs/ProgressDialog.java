...
public class ProgressDialog extends Dialog {
	...
	private Text text;
	private ProgressDialogModelProvider modelProvider;
	 ...
	 * @param style
	 */
	public ProgressDialog(Shell parent, List<Customer> customers) {
		super(parent);
		setText("SWT Dialog");
		modelProvider = new ProgressDialogModelProvider(customers);
	}
	...
	protected DataBindingContext initDataBindings() {
		...
		//
		IObservableValue lblProgressObserveTextObserveWidget = SWTObservables.observeText(lblProgress);
		IObservableValue modelProviderLabelMessageObserveValue = BeansObservables.observeValue(modelProvider, "labelMessage");
		bindingContext.bindValue(lblProgressObserveTextObserveWidget, modelProviderLabelMessageObserveValue, null, null);
		//
		IObservableValue textObserveTextObserveWidget = SWTObservables.observeText(text, SWT.Modify);
		IObservableValue modelProviderLogMessageObserveValue = BeansObservables.observeValue(modelProvider, "logMessage");
		bindingContext.bindValue(textObserveTextObserveWidget, modelProviderLogMessageObserveValue, null, null);
		//
