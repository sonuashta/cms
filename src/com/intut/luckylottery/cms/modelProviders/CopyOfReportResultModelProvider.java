...
public class CopyOfReportResultModelProvider {

	public CopyOfReportResultModelProvider(SearchResult searchResult) {
		...
		try {
			dialog.run(true, true, new IRunnableWithProgress() {
				public void run(IProgressMonitor monitor) {
					monitor.beginTask("Sending Messages....", 2);
					// begin task
					monitor.worked(1);

					try {
						
//						loader.sendMessages(getSearchResult().searchFilter,monitor);
					} catch (Exception e) {
